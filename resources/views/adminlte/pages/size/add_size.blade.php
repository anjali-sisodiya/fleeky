            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
                       <form action="/add_size" method="post">
    @csrf
    <div class="card-body">

        <div class="form-group">
            <label for="size_title">Size</label>
            <input type="text" name="size" class="form-control" id="size" placeholder="Please enter size...">
            @error('size')
...
@enderror
    ...
    <div class="card-footer">
        <button type="submit" class="btn btn-info btn-block">ADD SIZE</button>
    </div>
</form>
