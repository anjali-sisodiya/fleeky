            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li><a href="{{url('/front_end_logout')}}">Logout</a></li>
                  @else
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>daily<strong>Fleeky</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="aa-cartbox">
               ...
               @if($totalCartItem>0)
                  ...
                  <ul>
                    ...
                    @endphp
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="{{asset($cartItem->image)}}" alt="img"></a>
