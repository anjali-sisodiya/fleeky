          ...
          <div class="aa-product-details-area">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="{{asset($product[0]->image)}}" class="simpleLens-lens-image"><img src="{{asset($product[0]->image)}}" class="simpleLens-big-image"></a></div>
                      </div>
                      <div class="simpleLens-thumbnails-container" style="margin-top: 13px;">
                          <a data-big-image="{{asset($product[0]->image)}}" data-lens-image="{{asset($product[0]->image)}}" class="simpleLens-thumbnail-wrapper" href="#"><img src="{{asset($product[0]->image)}}" width="70px">
                          </a>   
                          ...
                          @if(isset($product_images[$product[0]->id][0]))
                            ...
                            <a data-big-image="{{asset($list->image)}}" data-lens-image="{{asset($list->image)}}" class="simpleLens-thumbnail-wrapper" href="#"><img src="{{asset($list->image)}}" width="70px">
                            </a>  
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-color-tag">
                      ...
                      <a href="javascript:void(0)" class="aa-color-{{strtolower($attr->color)}} product_color size_{{$attr->size}}"  onclick="change_product_color_image('{{asset($attr->image)}}', '{{$attr->color}}')"></a>
            ...
            <div class="aa-product-related-item">
              ...
              @if(isset($related_product[0]))
                    ...
                    <li>
                        <figure>
                        <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img src="{{asset($productArr->image)}}" style="width: 243px;" alt="{{$productArr->name}}"></a>
